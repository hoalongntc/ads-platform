  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
         ...
         */
        "exists": {
          url: urlBase + "/campains/:id/exists",
          method: "GET"
        },
         ...
         */
        "createChangeStream": {
          url: urlBase + "/campains/change-stream",
          method: "POST"
        },
      }
    );
